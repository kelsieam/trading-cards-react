...
function TradingCardContainer(tradingCardData) {
  for (tradingCard of tradingCardData) {
    ReactDOM.render(
      <TradingCard name='tradingCard[name]' skill='tradingCard[skill]' imgUrl='tradingCard[imgUrl]' />,
...
// ReactDOM.render(
//   <TradingCard name="Polymorphism" skill="shapeshifting" imgUrl="/static/img/polymorphism.jpeg" />,
//   document.querySelector('#polymorphism'),
// );

// ReactDOM.render(
//   <TradingCard name="Seedpy" skill="teleportation" imgUrl="/static/img/seedpy.jpeg" />,
